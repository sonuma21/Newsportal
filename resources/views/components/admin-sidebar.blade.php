<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown {{Request::routeIs('admin.category*') ? 'active' : ''}}">
        <a href="{{route("admin.category.index")}}" class="nav-link"><i class="fas fa-tags"></i><span>Category</span></a>
      </li>
      ...
      <li class="dropdown {{Request::routeIs('admin.advertise*') ? 'active' : ''}}">
        <a href="{{route("admin.advertise.index")}}" class="nav-link"><i class="fas fa-bullhorn"></i><span>Advertise</span></a>
      </li>
